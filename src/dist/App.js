...
var App = function () {
    var _a = react_1.useState(false), cartOpen = _a[0], setCartOpen = _a[1];
    ...
    return (React.createElement(App_styles_1.Wrapper, null,
        React.createElement(Drawer_1["default"], { anchor: 'right', open: cartOpen, onClose: function () { return setCartOpen(false); } },
            React.createElement(Cart_1["default"], { cartItems: cartItems, addToCart: handleAddToCart, removeFromCart: handleRemoveFromCart })),
        React.createElement(App_styles_1.StyledButton, { onClick: function () { return setCartOpen(true); } },
            React.createElement(Badge_1["default"], { badgeContent: getTotalItems(cartItems), color: 'error' },
                React.createElement(AddShoppingCart_1["default"], null))),
        React.createElement(Grid_1["default"], { container: true, spacing: 3 }, data === null || data === void 0 ? void 0 : data.map(function (item) { return (React.createElement(Grid_1["default"], { item: true, key: item.id, xs: 12, sm: 4 },
            React.createElement(Item_1["default"], { item: item, handleAddToCart: handleAddToCart }))); }))));
};
exports["default"] = App;
